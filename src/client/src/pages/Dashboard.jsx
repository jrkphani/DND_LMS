...
const Dashboard = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      {/* Search bar and hero/banner */}
      <div className="flex flex-col gap-6 mb-6">
        <div className="flex items-center gap-4">
          <input
            type="text"
            placeholder="Search your course here..."
            className="flex-1 px-4 py-2 rounded-lg border border-gray-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-200"
          />
          <button className="px-4 py-2 rounded-lg bg-violet-600 text-white font-semibold shadow hover:bg-violet-700 transition">Search</button>
        </div>
        <div className="rounded-2xl bg-gradient-to-r from-violet-500 to-pink-400 p-8 flex flex-col md:flex-row items-center gap-6 shadow-lg">
          <div className="flex-1">
            <div className="uppercase text-xs text-white/80 mb-2">Online Course</div>
            <div className="text-2xl md:text-3xl font-bold text-white mb-4">Sharpen Your Skills With Professional Online Courses</div>
            <button className="px-6 py-2 rounded-lg bg-white text-violet-700 font-bold shadow hover:bg-violet-50 transition">Join Now</button>
          </div>
          <div className="flex-1 flex justify-center">
            <div className="w-40 h-40 rounded-full bg-white/30 flex items-center justify-center">
              <div className="w-28 h-28 rounded-full bg-white/60" />
            </div>
          </div>
        </div>
      </div>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {courseTypeFilters.map((filter) => (
                    <button
                      ...
                      className={`px-5 py-2 rounded-lg font-semibold shadow-sm border transition-colors
